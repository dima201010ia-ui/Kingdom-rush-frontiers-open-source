-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all-desktop/game_gui.lua
...
function game_gui:init(w, h, game)
	...
	elseif IS_KR3 then
		layer_gui_hud:add_child(layer_wrath)
		layer_gui_hud:add_child(layer_timewarp)
	end
