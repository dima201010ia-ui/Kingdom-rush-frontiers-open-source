-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all-desktop/screen_splash.lua
...
function screen:start_animation()
	...
	local function start_logo_shine()
		local sound_fx = love.audio.newSource(KR_PATH_ASSETS_GAME_TARGET .. "/sounds/files/logo_shimmer.ogg", "stream")
