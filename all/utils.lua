-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all/utils.lua
...
function U.unlock_next_levels_in_ranges(unlock_data, levels, game_settings)
	local level_ranges = game_settings.level_ranges
	local last_campaign_level = game_settings.main_campaign_levels
	local dirty = false
