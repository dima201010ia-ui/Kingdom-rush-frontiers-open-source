-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all/storage_mappings.lua
...
function sm:append_slot(src, dst)
	...
	if KR_GAME == "kr1" then
		for _, row in pairs(self.slot_kr1) do
			self:do_row(row, src, dst)
		end
	elseif KR_GAME == "kr2" then
		for _, row in pairs(self.slot_kr2) do
			self:do_row(row, src, dst)
		end
