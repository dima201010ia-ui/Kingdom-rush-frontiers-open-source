-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all/scripts.lua
...
function scripts.aura_unit_regen.update(this, store)
	while true do
		...
		if (this.regen.ignore_stun or not target.unit.is_stunned) and (this.regen.ignore_freeze or not U.has_modifier_types(store, target, MOD_TYPE_FREEZE)) and not U.flag_has(target.vis.bans, F_MOD) and regen_cooldown <= store.tick_ts - this.aura.ts then
