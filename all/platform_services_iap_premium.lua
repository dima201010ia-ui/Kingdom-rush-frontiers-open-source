-- chunkname: @/var/folders/r9/xbxmw8n51957gv9ggzrytvf80000gp/T/com.ironhidegames.frontiers.windows.steam.ep3S4swo/all/platform_services_iap_premium.lua
...
function tiap:purchase_product(id)
	log.error("platform_services_iap_premium does not support purchase_product")

	return nil
end

function tiap:get_product(id, reference)
	log.error("platform_services_iap_premium does not support get_product")

	return nil
end

function tiap:get_offers()
	log.error("platform_services_iap_premium does not show offers")

	return {}
end

function tiap:get_hero_sales()
	log.error("platform_services_iap_premium does not show hero sales")
