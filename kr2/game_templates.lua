...
local arrow_1 = E:register_t("arrow_1", "arrow")
...
local tower_mage_1 = E:register_t("tower_mage_1", "tower")

E:add_comps(tower_mage_1, "attacks")
...
tower_mage_1.attacks.list[1] = E:clone_c("bullet_attack")
...
tower_mage_1.render.sprites[2] = E:clone_c("sprite")
...
tower_mage_1.render.sprites[3] = E:clone_c("sprite")
...
tower_mage_1.render.sprites[3].angles.idle = {
	"idleUp",
	"idleDown"
}
tower_mage_1.render.sprites[3].angles.shoot = {
	"shootingUp",
	"shootingDown"
}
...
local tower_mage_2 = E:register_t("tower_mage_2", "tower_mage_1")
...
local tower_mage_3 = E:register_t("tower_mage_3", "tower_mage_1")
...
local tower_engineer_1 = E:register_t("tower_engineer_1", "tower")

E:add_comps(tower_engineer_1, "attacks")
...
local tower_archer_1 = E:register_t("tower_archer_1", "tower")

E:add_comps(tower_archer_1, "attacks")
...
tt = E:register_t("decal_stage81_burner", "decal")
