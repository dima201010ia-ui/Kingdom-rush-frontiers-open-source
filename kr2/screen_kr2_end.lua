...
function screen:next_item()
	...
	if self.phase == "comic5" then
		...
		screen_comics.comic_data = love.filesystem.read(KR_PATH_GAME_TARGET .. "/data/comics/05.csv")
	...
	elseif self.phase == "comic6" then
		...
		screen_comics.comic_data = love.filesystem.read(KR_PATH_GAME_TARGET .. "/data/comics/06.csv")
